      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-5 justify-content-between">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h2><span>BIENVENIDO </span><span class="accent">A DON CARLOSgonka</span></h2>
            <p>EL BEBE ATRASADOR. Voluptatem itaque ea consequatur eveniet. Eum quas beatae cumque eum quaerat.</p>
            <div class="d-flex">
              <a href="" class="btn-get-started">contactanos</a>
            </div>
          </div>
          <div class="col-lg-5 order-1 order-lg-2">
            <img src="assets/img/ihl.jpg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
        ...
        <div class="slider-wrapper">
            ...
            <div class="card-list swiper-wrapper">
                <div style="text-align: center;" class="card-item swiper-slide">
                    ...
                    <h3 class="user-name">CONSTRUCCION</h3>
                </div>

                <div style="text-align: center;" class="card-item swiper-slide">
                    <img  style="width: 100px; text-align: center;" onclick="document.location.href='Gastroenterologia.html'"  src="assets/img/fontaneria.png" >
                    <h3 class="user-name">GASFITERIA</h3>
                </div>

                <div  style="text-align: center;" class="card-item swiper-slide">
                    <img style="width: 100px; text-align: center;" onclick="document.location.href='MedicinaGeneral.html'" src="assets/img/planta-de-energia.png">
                    <h3 class="user-name">ELECTRICIDAD</h3>
                </div>

                <div  style="text-align: center;" class="card-item swiper-slide">
                    <img  style="width: 100px; text-align: center;" onclick="document.location.href='Otorrinolaringologia.html'" src="assets/img/bote-de-pintura.png">
                    <h3 class="user-name">PINTURAS</h3>
                </div>

                <div  style="text-align: center;" class="card-item swiper-slide">
                    <img style="width: 100px; text-align: center;" onclick="document.location.href='Cardiologia.html'" src="assets/img/herramientas-manuales.png">
                    <h3 class="user-name">HERRAMIENTAS</h3>
                </div>

                <div  style="text-align: center;" class="card-item swiper-slide">
                    <img style="width: 100px; text-align: center;" style="width: 100px; text-align: center;" onclick="document.location.href='Psicologia.html'" src="assets/img/limpieza.png">
                    <h3 class="user-name">LIMPIEZA</h3>
                </div>

                <div  style="text-align: center;" class="card-item swiper-slide">
                    <img style="width: 100px; text-align: center;" onclick="document.location.href='Pediatria.html'" src="assets/img/bano.png">
                    <h3 class="user-name">BAÑO</h3>
                </div>
                
                <div  style="text-align: center;" class="card-item swiper-slide">
                    <img style="width: 100px; text-align: center;" onclick="document.location.href='Nutricion.html'" src="assets/img/hogar-dulce-hogar.png">
                    <h3 class="user-name">HOGAR</h3>
                </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              <div class="icon">
                <img style="width: 70px; text-align: center;" src="assets/img/Diapositiva6-1.jpg">
              </div>
              <h3>Catalogo Extendido</h3>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              <div class="icon">
              <img style="width: 140px; text-align: center;" src="assets/img/atencion.jpg">
              </div>
              <h3>atencion via whatsap</h3>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header" style="width: 400px;background: #fff;">
          
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body" style="width: 400px;background: #fff;">
